...
;;; We could then call cc as follows: (cc 100 us-coins)
;;; 292
;;;
...
;;; No, the order of the list coin-values does not affect the result.
;;; The reason is that the program actually counts all combinations of
;;; coin-values of forming the target amount of money.
